...
(function($) {
  ...
  $.fn.balloon = function(options) {
    return this.one("mouseenter touchstart", function first(e) {
      var $target = $(this), t = this;
      var $balloon = $target.off("mouseenter touchstart", first)
        .showBalloon(options).on("mouseenter touchstart", function(e) {
          isValidTargetEvent($target, e) && $target.showBalloon();
        }).data("balloon");
      if($balloon) {
        $balloon.on("mouseleave touchend", function(e) {
...
//add this to use the library above
        ...
        $("form").each(function () {
            ...
            for (i = 0; i < length; i++) {
                $(elements[i]).balloon({
                    ...
                    css: { border: 'solid 1px #000', color: '#000',fontSize: ".7rem" }
                });
            }
        });
    });